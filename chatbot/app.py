...
# app = Flask(__name__)
#{{Gender: male}} {{Age: 20}} {{Weight: 50kg}} {{Height: 160cm}}
# # Configure the API key
# genai.configure(api_key="AIzaSyCUmR0W-4NaVy2P8uyZxV61ieagUDnuX6o")
...
#     "{{Weight: user's weight}} {{Height: user's height}}. After getting gender, age, weight, "
